...
export default function Page() {
  return (
    <div className="bg-[#f5f5f5] text-[#333] font-serif mx-auto max-w-4xl px-8 py-12 shadow-lg">
      <h1 className="text-4xl font-bold mb-8">Thomas Hobbes &rsquo;s Leviathan</h1>
      ...
      <ol className="list-decimal list-inside space-y-6">
        ...
        <li>
          <a href="/chapter/3"> OF THE CONSEQUENCE OR TRAYNE OF IMAGINATIONS</a>
        </li>
        <li>
          <a href="/chapter/4"> OF SPEECH</a>
        </li>
        <li>
          <a href="/chapter/5"> OF REASON, AND SCIENCE.</a>
        </li>
        <li>
          <a href="/chapter/6">
        ...
        <li>
          <a href="/chapter/7"> OF THE ENDS OR RESOLUTIONS OF DISCOURSE</a>
        </li>
        <li>
          <a href="/chapter/8">
        ...
        <li>
          <a href="/chapter/9"> OF THE SEVERALL SUBJECTS OF KNOWLEDGE</a>
        </li>
        <li>
          <a href="/chapter/10">
            {" "}
        ...
        <li>
          <a href="/chapter/11"> OF THE DIFFERENCE OF MANNERS</a>
        </li>
        <li>
          <a href="/chapter/12"> OF RELIGION</a>
        </li>
        <li>
          <a href="/chapter/13">
        ...
        <li>
          <a href="/chapter/15"> OF OTHER LAWES OF NATURE</a>
        </li>
        <li>
          <a href="/chapter/16"> OF PERSONS, AUTHORS, AND THINGS PERSONATED</a>
        </li>
        <li>
          <a href="/chapter/17">
        ...
        <li>
          <a href="/chapter/20"> OF DOMINION PATERNALL AND DESPOTICALL</a>
        </li>
        <li>
          <a href="/chapter/21"> OF THE LIBERTY OF SUBJECTS</a>
        </li>
        <li>
          <a href="/chapter/22">
            {" "}
        ...
        <li>
          <a href="/chapter/25"> OF COUNSELL</a>
        </li>
        <li>
          <a href="/chapter/26"> OF CIVILL LAWES</a>
        </li>
        <li>
          <a href="/chapter/27">. OF CRIMES, EXCUSES, AND EXTENUATIONS</a>
        </li>
        <li>
          <a href="/chapter/28">I. OF PUNISHMENTS, AND REWARDS</a>
        </li>
        <li>
          <a href="/chapter/29">
        ...
        <li>
          <a href="/chapter/31"> OF THE KINGDOME OF GOD BY NATURE</a>
        </li>
        <li>
          <a href="/chapter/32">. OF THE PRINCIPLES OF CHRISTIAN POLITIQUES</a>
        </li>
        <li>
          <a href="/chapter/33">
        ...
        <li>
          <a href="/chapter/36">. OF THE WORD OF GOD, AND OF PROPHETS</a>
        </li>
        <li>
          <a href="/chapter/37">I. OF MIRACLES, AND THEIR USE</a>
        </li>
        <li>
          <a href="/chapter/38">
        ...
        <li>
          <a href="/chapter/41"> OF THE OFFICE OF OUR BLESSED SAVIOUR</a>
        </li>
        <li>
          <a href="/chapter/42"> OF POWER ECCLESIASTICALL</a>
        </li>
        <li>
          <a href="/chapter/43">
