export default function Page() {
  return (
    <div>
      <h2>CHAPTER II. OF IMAGINATION</h2>
      <p>
      ...
      <p>
        ...
        internall parts of a man, then, when he Sees, Dreams, &amp;c. For after
        the object is removed, or the eye shut, wee still retain an image of the
      ...
      <p>
        ...
        parcells in the Sense. And because in sense, the Brain, and Nerves,
        ...
        saving that the Organs of Sense being now benummed, so as there is no
        ...
        waking I often observe the absurdity of Dreames, but never dream of the
        absurdities of my waking Thoughts; I am well satisfied, that being
      ...
      <p>
        ...
        the thought and Image of some fearfull object (the motion from the brain
        to the inner parts, and from the inner parts to the Brain being
      ...
      <p>
        ...
        is easie to happen to a man full of fearfull thoughts; and whose
        conscience is much troubled; and that sleepeth, without the
      ...
      <p>
        ...
        think been on purpose, either taught, or not confuted, to keep in credit
        ...
        think it untrue; It is the part of a wise man, to believe them no
        ...
        people, men would be much more fitted than they are for civill
        Obedience.
      </p>
      <p>
        ...
        the Fancy to the Memory, and the Memory to the Judgement, like handing
