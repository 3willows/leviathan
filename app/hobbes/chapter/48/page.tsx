export default function Page() {
  return (
    <div>
      <h2>
        <a id="link2H_4_0725"></a>A REVIEW, AND CONCLUSION
      </h2>
      <p>
      ...
      <p>
        ...
        Amity with all those, with whom the Businesse of the world constrains us
        to converse: Which Businesse consisteth almost in nothing else but a
      ...
      <p>
        ...
        Eloquence, (though not perhaps in the Naturall Sciences, yet in the
        ...
        therefore no such Inconsistence of Humane Nature, with Civill Duties, as
        some think. I have known cleernesse of Judgment, and largenesse of
      ...
      <p>
        ...
        time of Peace.” For he that pretendeth a Right of Nature to preserve his
        owne body, cannot pretend a Right of Nature to destroy him, by whose
      ...
      <p>
        ...
        protected by the adverse party for his Contribution. Seeing therefore
        such contribution is every where, as a thing inevitable,
        (notwithstanding it be an assistance to the Enemy,) esteemed lawfull; as
        totall Submission, which is but an assistance to the Enemy, cannot be
        esteemed unlawfull. Besides, if a man consider that they who submit,
        ...
        upon him a new obligation of a Souldier, then he hath not the liberty to
        submit to a new Power, as long as the old one keeps the field, and
        giveth him means of subsistence, either in his Armies, or Garrisons: for
        in this case, he cannot complain of want of Protection, and means to
      ...
      <p>
        ...
        Conquest, is not the Victory it self; but the Acquisition by Victory, of
        ...
        that the Countrey was Pacified by Victory, when the people of it had
        promised Imperata Facere, that is, To Doe What The Romane People
      ...
      <p>
        ...
        of them justifie the War, by which their Power was at first gotten, and
        ...
        would perhaps be no tie of the Subjects obedience to their Soveraign at
        this day in all the world: wherein whilest they needlessely think to
      ...
      <p>
        ...
        Justification of the Cause of a Conqueror, the Reproach of the Cause of
        the Conquered, is for the most part necessary: but neither of them
      ...
      <p>
        ...
        this Kingdome Moses was Gods Lieutenant on Earth; and that it was he
        that told them what Laws God appointed to doe Execution; especially in
        ...
        upon the Guards, or other Souldiers of the Soveraign Power; or given to
        those, in whom want of means, contempt of honour, and hardnesse of
        ...
        Judge. The Witnesses were neverthelesse to be heard before they
        proceeded to Execution, unlesse the Fact were committed in the presence
        of the Congregation it self, or in sight of the lawfull Judges; for then
      ...
      <p>
        ...
        that heard it, did not kill him, but brought him before Moses, who put
        him under custody, till God should give Sentence against him; as
        ...
        Witnesse; the Law was known, and he the heir apparent to the
        ...
        shall kill him upon the word of Witnesses:” but Witnesses suppose a
        formall Judicature, and consequently condemn that pretence of Jus
        ...
        first stone. This is not Private Zeal, but Publique Condemnation. In
        ...
        people of the Town shall Stone him. Lastly, by pretence of these Laws it
        was, that St. Steven was Stoned, and not by pretence of Private Zeal:
      ...
      <p>
        ...
        Mercy-seat, is expressely set down (Numbers 7.89.) in these words, “From
        ...
        between the Cherubins he spake unto him.” But it is not declared in what
        consisted the praeeminence of the manner of Gods speaking to Moses,
        ...
        the difference consist in the cleernesse of the Vision. For Face to
      ...
      <p>
        ...
        Scripture. And therefore am perswaded, that he that shall read it with a
        purpose onely to be informed, shall be informed by it. But for those
      ...
      <p>
        ...
        of those old Writers, that contradicteth not sometimes both himself, and
        others; which makes their Testimonies insufficient. Fourthly, such
      ...
      <p>
        ...
        their Conversation) upon the People, there ought certainly to be great
        care taken, to have it pure, both from the Venime of Heathen
        ...
        than is necessary to make good the Publique Liberty, against the
      ...
      <p>
        ...
        seeing but the backs of them that erect a new;) yet I cannot think it
        will be condemned at this time, either by the Publique Judge of
