  ...
  return (
    ...
    <h2>
      ...
      <p>
        ...
        the Nostrill, in an Odour; To the Tongue and Palat, in a Savour; and to
        the rest of the body, in Heat, Cold, Hardnesse, Softnesse, and such
      ...
      <p>
        ...
        Being Seen; which entring at the Eare, maketh Hearing. Nay for the cause
        of Understanding also, they say the thing Understood sendeth forth
        Intelligible Species, that is, an Intelligible Being Seen; which comming
        into the Understanding, makes us Understand. I say not this, as
        disapproving the use of Universities: but because I am to speak
        hereafter of their office in a Common-wealth, I must let you see on all
