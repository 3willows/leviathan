export default function Page() {
  return (
    <div>
      <h2>
        <a id="link2HCH0003"></a>
        CHAPTER III.<br></br>OF THE CONSEQUENCE OR TRAYNE OF IMAGINATIONS
      </h2>
      <p>
      ...
      <p>
        ...
        Motions within us, reliques of those made in the Sense: And those
        ...
        which way any one part of it is guided by the finger. But because in
      ...
      <p>
        ...
        a Dream. Such are Commonly the thoughts of men, that are not onely
      ...
      <p>
        ...
        like of that which we ayme at; and from the thought of that, the thought
        of means to that mean; and so continually, till we come to some
        ...
        one of the seven wise men, made him give men this praecept, which is now
        worne out, Respice Finem; that is to say, in all your actions, look
        often upon what you would have, as the thing that directs all your
      ...
      <p>
        ...
        back, from place to place, and time to time, to find where, and when he
        had it; that is to say, to find some certain, and limited time and
        ...
        other occasion might make him lose it. This we call Remembrance, or
        Calling to mind: the Latines call it Reminiscentia, as it were a
        Re-Conning of our former actions.
      </p>
      <p>
        Sometimes a man knows a place determinate, within the compasse whereof
        his is to seek; and then his thoughts run over all the parts thereof, in
        the same manner, as one would sweep a room, to find a jewell; or as a
        Spaniel ranges the field, till he find a sent; or as a man should run
      ...
      <p>
        ...
        Officer, the Prison, the Judge, and the Gallowes. Which kind of
        thoughts, is called Foresight, and Prudence, or Providence; and
        ...
        how much one man has more experience of things past, than another; by so
        much also he is more Prudent, and his expectations the seldomer faile
      ...
      <p>
        ...
        kind of businesse, has most Signes, whereby to guesse at the Future
      ...
      <p>
        ...
        what courses and degrees, a flourishing State hath first come into
      ...
      <p>
        ...
        thing named; having no Conception of the thing, but of our own
